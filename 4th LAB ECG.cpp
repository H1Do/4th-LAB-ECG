...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("./x64/Content/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "./x64/Content/test.png");
        ...
        return m_pMesh->LoadMesh("./x64/Content/phoenix_ugv.md2");
    }
