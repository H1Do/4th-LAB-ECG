...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pTankMesh->LoadMesh("./x64/Content/phoenix_ugv.md2")) {
            return false;
        }
        ...
        if (!m_pSkyBox->Init(".",
                             "./x64/Content/sp3right.jpg",
                             "./x64/Content/sp3left.jpg",
                             "./x64/Content/sp3top.jpg",
                             "./x64/Content/sp3bot.jpg",
                             "./x64/Content/sp3front.jpg",
                             "./x64/Content/sp3back.jpg")) {
            return false;
        }
